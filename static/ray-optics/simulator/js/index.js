...
window.onkeydown = function (e) {
  ...
  if (e.altKey && e.keyCode==72) {
    ...
    document.getElementById('export_svg').classList.toggle('hide');
    document.getElementById('view_gallery').classList.toggle('hide');
    document.getElementById('tool_').classList.toggle('hide');
    document.getElementById('tool_power').classList.toggle('hide');
    document.getElementById('tool_protractor').classList.toggle('hide');
    document.getElementById('tool_blocker_').classList.toggle('hide');
    document.getElementById('tool_parallel').classList.toggle('hide');
    document.getElementById('tool_radiant_').classList.toggle('hide');
  }
